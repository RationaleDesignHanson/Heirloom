/**
 * Firebase Cloud Function for generating Open Graph meta tags
 * for public profile URLs
 *
 * URL Pattern (via Firebase Hosting rewrite):
 ...
 *
 * Fetches the user's profile from Firestore and generates
 * HTML with Open Graph meta tags for rich link previews.
 */
...
<head>
  ...
  <style>
    ...
    .bio { opacity: 0.9; margin: 0 0 20px; line-height: 1.5; }
