...
|----------|---------|--------|----------------|------------|------------|
| 0:00–0:04 | Hook | Collections grid with populated recipes | "Your recipes, finally organized" | `CAP_07B` | Fade in, slight zoom |
...
| 0:06–0:10 | — | Subscription screen / credits balance | "50 credits to start. 100/month with Premium." |
| 0:10–0:12 | — | Premium features list | — |
...
| `SS_10` | Start Free, Go Premium | `app-store/screenshots/SS_10_premium.png` | `CAP_02` + `CAP_21` |
...
- [ ] `CAP_21` — Credits balance / premium paywall ($4.99/mo, $29.99/yr, $99 lifetime)
